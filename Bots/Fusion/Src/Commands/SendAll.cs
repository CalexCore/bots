    ...
    public class SendAll : ICommand
    {
        public void Process(SocketUserMessage msg)
        {
            ...
            else
            {
                ...
                {
                    Sender.PrivateReply(msg, "Oof. No good. You didn't provide a valid address.").Wait();
                    return;
                }
                ...
                (SweepAllResponseData r) =>
                {
                    ...
                    Sender.PrivateReply(msg, $"{totalAmount} was sent with a fee of {totalFee} in {numTxs} transactions\r\n{txHashList}").Wait();
                },
                (RequestError e) =>
                {
